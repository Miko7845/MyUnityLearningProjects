...
public class Enemy : MonoBehaviour
{
    ...
    Rigidbody enemyRb;              // Rigidbody of the enemy
    GameObject player;              // GameObject of the player
    float masterPower = 5.0f;
    ...
    void Update()
    {
        ...
        if (transform.position.y < -8)                                                          // Enemies are destroyed when they fall.
        {
            Destroy(gameObject);
        }
    }
