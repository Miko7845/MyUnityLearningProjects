...
{
    private Transform target;                                                                       // Field to store a reference to the target
    private float speed = 15.0f;                                                                    
    private bool homing;                                                                            // Field to store the state of the bullet (whether it is chasing the target or not)
    private float bulletStrength = 15.0f;
    private float aliveTimer = 5.0f;                                                                // Field to store the lifetime of the bullet
